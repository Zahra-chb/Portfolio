  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(SERVICE_ID, TEMPLATE_ID, templateParams, PUBLIC_KEY)
      ...
      .catch((error) => {
        ...
        setError(`Erreur: ${error.text || 'Veuillez réessayer plus tard.'}`);
        setIsLoading(false);
      });
  };
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="4"
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary transition-colors resize-none"
              ...
              <motion.button
                type="submit"
                disabled={isLoading}
                className="w-full bg-primary text-white py-3 rounded-lg font-medium hover:shadow-lg hover:shadow-primary/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
